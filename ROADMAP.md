...
> **Paleta:** `#B87333` (primary) · `#0E0E0E` (bg) · `#F0F0F0` (text)
...
- [x] **3.5** `<HowItWorks>` ” diagrama Server â†’ Agent â†’ gRPC â†’ Dashboard
...
En el dashboard de Vercel â†’ Settings â†’ Domains â†’ añadir `cupraflow.dev`
